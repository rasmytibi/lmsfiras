...
@section('content')
    ...
    <div class="portlet light ">
        ...
        <div class="portlet-body form">
            <!-- BEGIN FORM-->
            <form action="{{ route('post-settings') }}" method="post" class="form-horizontal" enctype="multipart/form-data">
                @method('POST')
                @csrf
                <div class="form-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <div class="input-icon">
                                ...
                                <input type="file" name="logoFile" class="custom-file-input" id="logoFile">
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <div class="input-icon">
                                <i class="fa fa-map"></i>
                                <input type="url"  required name="map" class="form-control" placeholder="map" value="@if(old('map')){{old('map')}}@elseif(isset($settings->map)){{$settings->map}}@else{{''}}@endif">
                            </div>
                        </div>
                    </div>
{{--                    <td>@if($settings->logo)<a href="{{ asset('storage/' . $settings->logo) }}" target="_blank"><img  width="100" style="align-items: center" src="{{ asset('storage/' . $settings->logo) }}"/></a>@endif</td>--}}
