        ...
        <div class="search-warp">
            ...
            <div class="row">
                <div class="col-md-10 offset-md-1">
                    <!-- search form -->
                    <form class="course-search-form" action="<?php echo e(route('course-search')); ?>">
                        <input type="text" class="col-md-4" name="q" id="q" value="<?php echo e(request()->get("q")); ?>" placeholder="Course">
...
<?php /**PATH I:\project\lms new22\lms\resources\views/frontEnd/layouts/search.blade.php ENDPATH**/ ?>