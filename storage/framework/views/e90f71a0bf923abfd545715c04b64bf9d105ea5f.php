                ...
                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('setting')): ?>
                    <li class="nav-item start  <?php echo e(request()->is('setting' ? 'active' : '')); ?>">
                        ...
                        <ul class="sub-menu">
                            ...
                            <?php endif; ?>
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('emails')): ?>
                                    <li class="nav-item start <?php echo e($request->segment(2) == 'emails' ? 'active active-sub' : ''); ?>">
                                        <a href="<?php echo e(route('email-all')); ?>" class="nav-link ">
                                            <i class="fa fa-briefcase"></i>
                                            <span class="title">
                                <?php echo app('translator')->get('global.global_mail-list'); ?>

                                        </a>
                                    </li>
                                <?php endif; ?>
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('subscribe')): ?>
                                        <li class="nav-item start <?php echo e($request->segment(2) == 'subscribe' ? 'active active-sub' : ''); ?>">
                                            <a href="<?php echo e(route('subscribe.show')); ?>" class="nav-link ">
                                                <i class="fa fa-briefcase"></i>
                                                <span class="title">
                                <?php echo app('translator')->get('global.global_subscribe'); ?>
                            </span>
                                        </a>
                                    </li>
                                <?php endif; ?>
...
<?php /**PATH I:\project\lms new22\lms\resources\views/layouts/admin/sidebar.blade.php ENDPATH**/ ?>