        ...
        <div class="footer-warp">
            <div class="row">
                ...
                <div class="widget-item">
                    ...
                    <form action="<?php echo e(route('email')); ?>" method="post" class="footer-newslatter" >
                        <?php echo csrf_field(); ?>
...
<!-- footer section end -->
<?php /**PATH I:\project\lms new22\lms\resources\views/frontEnd/layouts/footer.blade.php ENDPATH**/ ?>